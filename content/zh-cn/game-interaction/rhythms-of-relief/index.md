...
该项目的一个核心观点是，用于压力缓解的音乐并没有一种固定的、适用于所有人的类型。有些学生可能更偏好平静、柔和、放松的歌曲，而另一些学生则可能通过更有能量或更具激励感的音乐来处理压力。
...
由于压力应对具有很强的个人差异和情境依赖性，因而该原型希望让用户在推荐过程中能够自主选择。。用户可以收听推荐歌曲、跳过歌曲、喜欢自己偏好的歌曲，并通过多个偏好控制按钮调整推荐方向。原型包含以下控制功能：
